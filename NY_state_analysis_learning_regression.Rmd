...
ggplot(data = df_agg_lc, aes(x = nrc_desc, y = NUM_FREE_LUNCH, fill=nrc_desc)) +
  geom_col() +
  ggtitle("Number of Students eligible for Free Lunches in New York State") +
...
ggplot(data = df_agg_lc, aes(x = nrc_desc, y = NUM_REDUCED_LUNCH, fill=nrc_desc)) +
  geom_col() +
  ggtitle("Number of Students eligible for Reduced Price Lunches in New York State") +
  theme(axis.text.x = element_text(angle=60, hjust=1), 
        legend.position = "none",
        plot.title = element_text(size=16, face="bold")) +
...
ggplot(data = df_race_ethnicity, aes(x = subgroup_name, y = enroll_cnt, fill = nrc_desc)) +
  ...
  ggtitle("Student Enrollment by Race/Ethnicity and Needs Resource Group") +
  theme(axis.text.x = element_text(angle=60, hjust=1),
